<div id="wirtschaftsprüfung_page" class="otherPages">
<?php 
/*
* Template Name: Wirtschaftsprüfung
*/
get_header(); 
?>
	...
	<div class="container">
		<div class="konfigurator_breadcrumbs">
			<ul class="breadcrumbs">
				...
				<li class="breadcrumbs_item">
					<a href="/wirtschaftsprufung" class="breadcrumbs_active">Wirtschaftsprufung</a>
				</li>
			</ul>
		</div>
	</div>
...
<div class="rechtsberatung_content leistungen-submenuBlock">
	<div class="container">
		...
		<div class="box-3images">
			<div class="page_titles">
				<p class="title"><?= ( get_field('second_section')['title'] ); ?></p>
    			<p class="text1"><?= ( get_field('second_section')['text'] ); ?></p>
			</div>
			<div class="row">
				<div class="col-sm-4">
					<div class="image"><img src="<?= ( get_field('second_section')['first_image'] ); ?>"></div>
				</div>
				<div class="col-sm-4">
					<div class="image"><img src="<?php echo get_bloginfo('template_directory')?>/assets/images/steuerberatungImg2.png"></div>
				</div>
				<div class="col-sm-4">
					<div class="image"><img src="<?= ( get_field('second_section')['third_image'] ); ?>"></div>
				</div>
			</div>
		</div>
	</div>
